...
public:
  ...
  void write_profile_acceleration(int servo_id, unsigned int pac);
  void write_profile_velocity(int servo_id, unsigned int positionvalue);
...
private:
  ...
  const int _GRIPPER_CLOSE [2] = {2000, 2000};
